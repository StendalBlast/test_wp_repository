<?php
/**
 * Test_theme template for displaying Search-Results-Pages
 *
 * @package WordPress
	...
	<section class="page-content primary" role="main"><?php
		...
		if ( have_posts() ) : ?>
			...
			<div class="search-title">
				<h1 ><?php printf( __( 'Search Results for: %s', 'Kabachok' ), get_search_query() ); ?></h1>

				<div class="second-search">
					<p>
						<?php _e( 'Not what you searched for? Try again with some different keywords.', 'Kabachok' ); ?>
					</p>
